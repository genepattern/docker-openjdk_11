...
CONTAINER_ID="`docker run -d   --mount type=bind,src=$GP_LOCAL_PREFIX$GP_METADATA_DIR,dst=$GP_METADATA_DIR $MOUNT_STR -t $GP_DOCKER_CONTAINER sleep $GP_MAX_WALLTIMEs`"
